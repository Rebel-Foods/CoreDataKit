...
public final class CoreDataStack {
    ...
    */
    ...
    public init(databaseName name: String) {
        ...
        savingContext.persistentStoreCoordinator = persistentContainer.persistentStoreCoordinator
    ...
    func loadContainer() {
        persistentContainer.loadPersistentStores(completionHandler: { (storeDescription, error) in
            ...
            if let error = error as NSError? {
                 ...
                 */
                CoreDatabaseKit.default.logger.log(error: CKError(error))
//                CoreDatabaseKit.default.logger.fatalError("Unresolved error \(error), \(error.userInfo)")
            }
        })
    }
